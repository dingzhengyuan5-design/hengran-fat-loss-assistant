...
const 文件=["js/catalog.js","js/exercise-catalog.js","js/motion-catalog.js","js/recipe-catalog.js","js/external-food-catalog.js","js/engine.js","js/crypto-sync.js","js/app.js"];
const 内容=[];
